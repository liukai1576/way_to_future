      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-neutral-500">总阅读量</h3>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-neutral-500">总停留时长 (分钟)</h3>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-neutral-500">活跃 CEO 数</h3>
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-neutral-200 flex flex-col justify-between">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-medium text-neutral-500">分享次数</h3>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="text-neutral-500 border-b border-neutral-100">
                  <th className="pb-4 font-medium">姓名 / 机构</th>
                  <th className="pb-4 font-medium text-center">阅读</th>
                  <th className="pb-4 font-medium text-center">收听</th>
                  <th className="pb-4 font-medium text-right">活跃时长</th>
                </tr>
              </thead>
                ...
                {userStats.map((user, i) => (
                  <tr key={i} className="group">
                    ...
                    <td className="py-4 text-center">
                      <span className="bg-orange-50 text-orange-600 px-2 py-0.5 rounded-full font-bold">{user.views}</span>
                    </td>
                    <td className="py-4 text-center">
                      <span className="bg-blue-50 text-blue-600 px-2 py-0.5 rounded-full font-bold">{user.listens}</span>
                    </td>
                    <td className="py-4 text-right font-medium text-neutral-700">
                      {Math.round(user.total_duration / 60)} 分钟
                    </td>
                  </tr>
                ))}
              </tbody>
